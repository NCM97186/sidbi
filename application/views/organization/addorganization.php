                ...
                <div class="panel-body" style="height: 100%;overflow: scroll;">
                  <form class="form-horizontal" method="post">
					...
					<div class="form-group">
					  ...
					  <div class="form-group">
					  <label class="col-sm-2 control-label">Orga Certificate Number</label>
                      <div class="col-sm-10">
   ...
   <option value="Zimbabwe">Zimbabwe</option></select>
                    ...
                    <div class="form-group">
                      <div class="col-sm-4 col-sm-offset-2">
                        <button type="button" class="btn btn-default" onclick="window.location='https://ukac.uk.com/ukacmanagercert/organization'" >Cancel</button>
