...
<section class="panel panel-default">
                <header class="panel-heading font-bold">
                  User Entry
				<button onclick="location.href='<?php echo base_url(); ?>user';" class="btn btn-sm btn-default" style="float:right;background-color:#177bbb;color:white !important;padding:3px 22px"><strong>Back</strong></button> 		
                </header>
